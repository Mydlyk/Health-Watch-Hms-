...
import MapView, { PROVIDER_GOOGLE,enableLatestRenderer,Marker,Circle } from 'react-native-maps'; 
import RNFetchBlob from 'rn-fetch-blob';
const Tab = createBottomTabNavigator();

export default function PupilLocalization({route,navigation}) {
...
<View>
<Text style={styles.Text_title3}>Localization</Text>
<View style={styles.container_long}>
<Text style={styles.doctor_text2}>Latitude:</Text>
<Text style={styles.doctor_text3}>55.2343</Text>
</View>
<View style={styles.container_long}>
<Text style={styles.doctor_text2}>Longitude:</Text>
<Text style={styles.doctor_text3}>55.2343</Text>
</View>
</View>
<Text style={styles.Text_title3}>Map</Text>
<View style={styles.container}>
     <MapView
       ...
       region={{
         ...
         key:"AIzaSyAPlHbxMrfjUxkZvvjif9NBWdiQSBZ64QQ"
       }}
     >
       <Marker
     coordinate={{
     ...
     pinColor="#fff"
     title="Pupil localization"
     />
    <Circle
    center={{latitude: 51.2553,
      longitude: 22.5413,}}
      radius={1000}
      strokeColor="rgba(55, 0, 0, 0.2)"
      StrokeWidth = {8}
      fillColor="rgba(55, 0, 0, 0.2)"
    />
     </MapView>
